...
public class SalaryLabelGuiFX extends Application {
    ...
    public void start(Stage applicationStage) {
        ...
        GridPane gridPane;   // Positions components within scene
        Label wageLabel;     // Label for hourly salary
        Label salaryLabel;   // Label for yearly salary
        TextField salField;  // Displays yearly salary
        TextField wageField; // Displays hourly wage
        Insets gridPadding;
